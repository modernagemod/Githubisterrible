...
country = {
	...
	GOLD_TO_CASH_RATE = 5, -- Amount of money generated per gold unit
	...
	CAMPAIGN_EVENT_MIN_TIME = 28 ,-- never more often than 3 weeks between
	...
	DIPLOMAT_TRAVEL_TIME = 7, -- MAM EDIT
	...
	INVESTMENT_SCORE_FACTOR = 0.0075, -- MAM EDIT, how much foreign investment money counts towards your industry score
	...
	NAVAL_BASE_SUPPLY_SCORE_BASE = 20, -- base value that is powered by level of naval base. Determines the naval supplying capabilities.
...
economy = {
	...
	LOAN_BASE_INTEREST			= 0.015,
	BANKRUPTCY_EXTERNAL_LOAN_YEARS	= 10,
	BANKRUPTCY_FACTOR = 0.4,
	...
	SMALL_DEBT_LIMIT = 20000, -- MAM EDIT
...
military = {
	...
	SOLDIER_TO_POP_DAMAGE = 0.2, -- set to default of 20% = KIA
	LAND_SPEED_MODIFIER = 1.2, -- MAM EDIT
	NAVAL_SPEED_MODIFIER = 3, -- MAM EDIT
	EXP_GAIN_DIV = 0.05,
	LEADER_RECRUIT_COST = 20,
	SUPPLY_RANGE = 200, -- MAM EDIT
	...
	GAS_ATTACK_MODIFIER = 4,		-- MAM EDIT
	COMBATLOSS_WAR_EXHAUSTION = 5, 	-- MAM EDIT, base war exhastion in combat
	...
	AI_BLOCKADE_RANGE = 500, -- max distance the AI will send out blockade fleets from their home base
	...
	SIEGE_ATTRITION = 0.1, -- fixed attrition on sieging units
	...
	NAVAL_LOW_SUPPLY_DAMAGE_MIN_STR = 20.0, -- when low supply, the navy will supply STR damage but no less then X% to avoid destruction (value from 0 to 100.0)
...
diplomacy = {
	...
	MAX_INFLUENCE = 100,
	WARSUBSIDIES_PERCENT = 0.33, 	-- MAM EDIT, How many percent of imports you are going to pay each day(mil. constructions and mil. maintainence)
...
pops = {
	...
	ASSIMILATION_SCALE = 0.0001, -- MAM EDIT
	CONVERSION_SCALE = 0.0001,
	IMMIGRATION_SCALE = 0.001, -- MAM EDIT

	PROMOTION_SCALE = 0.002,
	PROMOTION_ASSIMILATION_CHANCE = 0,
	LUXURY_THRESHOLD = 500,
	BASE_GOODS_DEMAND = 1, -- MAM EDIT, was 0.8
	...
	MIL_HAS_LUXURY_NEED = -0.1,
	MIL_NO_LIFE_NEED = 0.2,
	MIL_REQUIRE_REFORM = 0.2,
	MIL_IDEOLOGY = -0.05,
	MIL_RULING_PARTY = -0.05,
	MIL_REFORM_IMPACT = 1,
	...
	CON_POOR_CLERGY = -1.25,
	CON_MIDRICH_CLERGY = -0.625,
	CON_REFORM_IMPACT = -25,
	CON_COLONIAL_FACTOR = 0.25,
	RULING_PARTY_HAPPY_CHANGE = -0.5,
	RULING_PARTY_ANGRY_CHANGE = 1,

	PDEF_BASE_CON = 20.0,			-- so half'ed effect.
	
	NATIONAL_FOCUS_DIVIDER = 400000.0,
	
	POP_SAVINGS = 0.05,	-- MAM EDIT
	
	STATE_CREATION_ADMIN_LIMIT = 0.01,
	MIL_TO_JOIN_REBEL = 8.5, -- Rebels over this will join a faction
	...
	LARGE_POPULATION_LIMIT = 90000000, -- MAM edit (x10), untested - joe
...
ai =
{
	...
	POP_PROJECT_INVESTMENT_MAX_BUDGET_FACTOR = 0.5, -- how much % of our current budget can be spend on the pop project investments.
	...
	CHANCE_BUILD_RAILROAD = 0.8, -- chances in % of AI decisions (max value 1.0)
	CHANCE_BUILD_NAVAL_BASE = 0.2,
	CHANCE_BUILD_FORT = 0.1,
	CHANCE_INVEST_POP_PROJ = 0.5,
	CHANCE_FOREIGN_INVEST = 0.1,
